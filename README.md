...
> **Status: Phase 1 of 14 complete.** This README is intentionally partial
...
## Running Locally (Phase 1 scope)

There is no database wiring yet — this only proves the backend and
frontend skeletons boot and can talk to each other.
...
- [ ] Phase 2 — Database models and Alembic migrations
